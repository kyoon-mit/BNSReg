...
SWEEP_DIR=${TOP_DIR}/sweeps/ai4gw@cern/s4d_gaussnll_snr_10
SLURM_SCRIPT=${TOP_DIR}/slurm/parameter_estimation/s4d_gaussnll_sweep_worker.slurm
LOG_FILE=/n/holystore01/LABS/iaifi_lab/Lab/kyoon/slurm_logs/ai4gw@cern/s4d_gaussnll_snr_10/sweep_jobs.log
