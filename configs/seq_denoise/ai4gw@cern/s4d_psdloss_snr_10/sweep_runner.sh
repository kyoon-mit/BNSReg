#!/bin/bash
# Wrapper called by wandb sweep agent for the seq_denoise PSD loss sweep.
...
RUN_NAME="seq_denoise_psd_0-4s_d${D_MODEL}_s${D_STATE}_l${N_LAYERS}"
SAVE_DIR="/n/holystore01/LABS/iaifi_lab/Lab/kyoon/BNSReg/outputs/ai4gw@cern/s4d_psdloss_snr_10/${RUN_NAME}"
