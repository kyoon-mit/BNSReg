...
# Base: 512 @ d_model=32, n_layers=4. Floor at 16.
BATCH_SIZE=$(( 512 * 32 / D_MODEL * 4 / N_LAYERS ))
if (( BATCH_SIZE < 16 )); then BATCH_SIZE=16; fi

RUN_NAME="${VAR}_${begin}_${end}s_d${D_MODEL}_s${D_STATE}_l${N_LAYERS}"
SAVE_DIR="/n/holystore01/LABS/iaifi_lab/Lab/kyoon/BNSReg/outputs/ai4gw@cern__s4d_gaussnll_sig_only/${RUN_NAME}"
