...
from BNSReg.dataset.seq_encoder_h1_dataset import BNSDatasetSeqEncoderH1

class LitBNSDataSeqEncoderH1(L.LightningDataModule):
    ...
    def setup(self, stage: str | None = None):
        ...
        if stage == "fit":
            ...
            self.train_dataset = BNSDatasetSeqEncoderH1('train', self.cfg)
            self.val_dataset = BNSDatasetSeqEncoderH1('val', self.cfg)

        # Assign test dataset for use in dataloader
        elif stage in ("test", "predict"):
            self.test_dataset = BNSDatasetSeqEncoderH1('test', self.cfg)
